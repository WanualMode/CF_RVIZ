...
def generate_launch_description():
    ...
    sdf_file  =  os.path.join(pkg_project_description, 'models', 'manipulator', 'model.sdf')
    ...
    bridge = Node(
        ...
        parameters=[{
            'config_file': os.path.join(pkg_project_bringup, 'config', 'ros_gz_example_bridge_manipulator.yaml'),
